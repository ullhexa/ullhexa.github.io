...
export function createDiceTools(){
  ...
  document.addEventListener('pointerdown',e=>{if(!panel.hidden&&!panel.contains(e.target)&&!toggle.contains(e.target)){close();if(stage.contains(e.target)){e.preventDefault();e.stopImmediatePropagation();}}},true);
