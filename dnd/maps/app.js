import {createMapNavigation} from './map-navigation.js?v=39';
import {chevronIcon} from './control-icons.js?v=39';
import {createSpellLibrary} from './spell-library.js?v=39';
import {createReferenceViewers} from './reference-viewers.js?v=39';
import {configureSession,readSessionValue,writeSessionValue,autoSaveEnabled,setAutoSave} from './session-storage.js?v=39';
import {persistAssets} from './local-assets.js?v=39';
import {createScenery} from './scenery.js?v=39';
import {consumeMapDismissal} from './map-dismissal.js?v=39';
import {boundedCamera,cameraViewBox,cameraGeometry} from './camera.js?v=39';
import {listenForBoardReset,initializeControlBoard} from './board-reset.js?v=39';
import {createDiceTools} from './dice.js?v=39';
import {fetchJSON,loadRaster} from './resource-loading.js?v=39';
import {storyCatalog,nextStory} from './story-assets.js?v=39';
import {createItemsUI} from './items-ui.js?v=39';
import {floorList,selectedFloor,placeView,selectFloor,interactionOnFloor} from './floors.js?v=39';
import {createHistory} from './history.js?v=39';
import {placeStep,setPlaceStep,cyclePlace} from './map-events.js?v=39';
import {setupSidebarResize} from './sidebar-resize.js?v=39';
import {syncCampaign,normalizeCampaign,mapTokens,combatants,snapPoint} from './combat-state.js?v=39';
import {createCombatUI,createLibraries} from './combat-ui.js?v=39';
import {createFogTools} from './fog-tools.js?v=39';
import {normalizeFog} from './fog-state.js?v=39';
import {customCatalog,saveCustomCatalog,createMapUpload,resolveMapArt,mapContentKey} from './custom-maps.js?v=39';
import {createSessionBundle} from './session-bundle.js?v=39';
import { startDMShell } from './dm-shell.js?v=39';
import { openPlayerWindow } from './display-window.js?v=39';
import { validateMap, initialState, sanitizeState, isVisible, toggleInteraction, distanceBetween } from './state.js?v=39';
import { createEncounterTools } from './encounter-tools.js?v=39';
import { playerProjection, formation, moveParty } from './encounter-state.js?v=39';
import { createMapMenu } from './map-menu.js?v=39';
import { createSaveControls } from './save-controls.js?v=39';
import { parseSave, restoreSave } from './save-file.js?v=39';
import { createLighting } from './lighting.js?v=39';
import { setupFullscreen } from './fullscreen.js?v=39';
import { startPlayerDisplay } from './player-display.js?v=39';
import { createDirector } from './director.js?v=39';
import { normalizeProject } from './presentation-state.js?v=39';
...
async function start() {
  ...
  const catalog = (await fetchJSON('./maps/catalog.json?v=39')).maps;
  ...
  const loadMap = async item => {
    const content=validateMap(item.map||await fetchJSON(`${item.manifest}?v=39`));
  ...
  if (!player) {
    ...
    $('open-player').addEventListener('click', () => {
      ...
      save();const url=new URL(location.href);url.search=new URLSearchParams({view:'player',session,map:map.id,build:'39',popup:'1'}).toString();
