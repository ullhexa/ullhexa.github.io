...
import {createUserManual} from './user-manual.js?v=67';
...
import {createDiceTools} from './dice.js?v=68';
...
async function start() {
  ...
  if (!player) {
    ...
    $('open-player').addEventListener('click', () => {
      ...
      save();const url=new URL(location.href);url.search=new URLSearchParams({view:'player',session,map:map.id,build:'68',popup:'1'}).toString();
