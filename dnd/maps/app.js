import {createMapNavigation} from './map-navigation.js?v=38';
import {chevronIcon} from './control-icons.js?v=38';
import {createSpellLibrary} from './spell-library.js?v=38';
import {createReferenceViewers} from './reference-viewers.js?v=38';
import {configureSession,readSessionValue,writeSessionValue,autoSaveEnabled,setAutoSave} from './session-storage.js?v=38';
import {persistAssets} from './local-assets.js?v=38';
import {createScenery} from './scenery.js?v=38';
import {consumeMapDismissal} from './map-dismissal.js?v=38';
import {boundedCamera,cameraViewBox,cameraGeometry} from './camera.js?v=38';
import {listenForBoardReset,initializeControlBoard} from './board-reset.js?v=38';
import {createDiceTools} from './dice.js?v=38';
import {fetchJSON,loadRaster} from './resource-loading.js?v=38';
import {storyCatalog,nextStory} from './story-assets.js?v=38';
import {createItemsUI} from './items-ui.js?v=38';
import {floorList,selectedFloor,placeView,selectFloor,interactionOnFloor} from './floors.js?v=38';
import {createHistory} from './history.js?v=38';
import {placeStep,setPlaceStep,cyclePlace} from './map-events.js?v=38';
import {setupSidebarResize} from './sidebar-resize.js?v=38';
import {syncCampaign,normalizeCampaign,mapTokens,combatants,snapPoint} from './combat-state.js?v=38';
import {createCombatUI,createLibraries} from './combat-ui.js?v=38';
import {createFogTools} from './fog-tools.js?v=38';
import {normalizeFog} from './fog-state.js?v=38';
import {customCatalog,saveCustomCatalog,createMapUpload,resolveMapArt,mapContentKey} from './custom-maps.js?v=38';
import {createSessionBundle} from './session-bundle.js?v=38';
import { startDMShell } from './dm-shell.js?v=38';
import { openPlayerWindow } from './display-window.js?v=38';
import { validateMap, initialState, sanitizeState, isVisible, toggleInteraction, distanceBetween } from './state.js?v=38';
import { createEncounterTools } from './encounter-tools.js?v=38';
import { playerProjection, formation, moveParty } from './encounter-state.js?v=38';
import { createMapMenu } from './map-menu.js?v=38';
import { createSaveControls } from './save-controls.js?v=38';
import { parseSave, restoreSave } from './save-file.js?v=38';
import { createLighting } from './lighting.js?v=38';
import { setupFullscreen } from './fullscreen.js?v=38';
import { startPlayerDisplay } from './player-display.js?v=38';
import { createDirector } from './director.js?v=38';
import { normalizeProject } from './presentation-state.js?v=38';
...
async function start() {
  ...
  const loadMap = async item => {
    const content=validateMap(item.map||await fetchJSON(`${item.manifest}?v=38`));
  ...
  if (!player) {
    ...
    $('open-player').addEventListener('click', () => {
      ...
      save();const url=new URL(location.href);url.search=new URLSearchParams({view:'player',session,map:map.id,build:'38',popup:'1'}).toString();
