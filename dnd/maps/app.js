import {createMapNavigation} from './map-navigation.js?v=37';
import {chevronIcon} from './control-icons.js?v=37';
import {createSpellLibrary} from './spell-library.js?v=37';
import {createReferenceViewers} from './reference-viewers.js?v=37';
import {configureSession,readSessionValue,writeSessionValue,autoSaveEnabled,setAutoSave} from './session-storage.js?v=37';
import {persistAssets} from './local-assets.js?v=37';
import {createScenery} from './scenery.js?v=37';
import {consumeMapDismissal} from './map-dismissal.js?v=37';
import {boundedCamera,cameraViewBox,cameraGeometry} from './camera.js?v=37';
import {listenForBoardReset,initializeControlBoard} from './board-reset.js?v=37';
import {createDiceTools} from './dice.js?v=37';
import {fetchJSON,loadRaster} from './resource-loading.js?v=37';
import {storyCatalog,nextStory} from './story-assets.js?v=37';
import {createItemsUI} from './items-ui.js?v=37';
import {floorList,selectedFloor,placeView,selectFloor,interactionOnFloor} from './floors.js?v=37';
import {createHistory} from './history.js?v=37';
import {placeStep,setPlaceStep,cyclePlace} from './map-events.js?v=37';
import {setupSidebarResize} from './sidebar-resize.js?v=37';
import {syncCampaign,normalizeCampaign,mapTokens,combatants,snapPoint} from './combat-state.js?v=37';
import {createCombatUI,createLibraries} from './combat-ui.js?v=37';
import {createFogTools} from './fog-tools.js?v=37';
import {normalizeFog} from './fog-state.js?v=37';
import {customCatalog,saveCustomCatalog,createMapUpload,resolveMapArt,mapContentKey} from './custom-maps.js?v=37';
import {createSessionBundle} from './session-bundle.js?v=37';
import { startDMShell } from './dm-shell.js?v=37';
import { openPlayerWindow } from './display-window.js?v=37';
import { validateMap, initialState, sanitizeState, isVisible, toggleInteraction, distanceBetween } from './state.js?v=37';
import { createEncounterTools } from './encounter-tools.js?v=37';
import { playerProjection, formation, moveParty } from './encounter-state.js?v=37';
import { createMapMenu } from './map-menu.js?v=37';
import { createSaveControls } from './save-controls.js?v=37';
import { parseSave, restoreSave } from './save-file.js?v=37';
import { createLighting } from './lighting.js?v=37';
import { setupFullscreen } from './fullscreen.js?v=37';
import { startPlayerDisplay } from './player-display.js?v=37';
import { createDirector } from './director.js?v=37';
import { normalizeProject } from './presentation-state.js?v=37';
...
async function start() {
  ...
  const loadMap = async item => {
    const content=validateMap(item.map||await fetchJSON(`${item.manifest}?v=37`));
  ...
  if (!player) {
    ...
    $('open-player').addEventListener('click', () => {
      ...
      save();const url=new URL(location.href);url.search=new URLSearchParams({view:'player',session,map:map.id,build:'37',popup:'1'}).toString();
