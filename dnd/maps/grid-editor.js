import {orientationIcon} from './control-icons.js?v=45';
import {showDialog} from './dialogs.js?v=45';
import {imageTypeNote} from './image-import.js?v=45';
import {identityTransform,transformPoint,composeTransform,imageOperation} from './map-orientation.js?v=45';
import {el,button,label} from './editor-dom.js?v=45';
