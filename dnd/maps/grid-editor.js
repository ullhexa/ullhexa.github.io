import {orientationIcon} from './control-icons.js?v=44';
import {showDialog} from './dialogs.js?v=44';
import {imageTypeNote} from './image-import.js?v=44';
import {identityTransform,transformPoint,composeTransform,imageOperation} from './map-orientation.js?v=44';
import {el,button,label} from './editor-dom.js?v=44';
