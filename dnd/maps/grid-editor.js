import {orientationIcon} from './control-icons.js?v=61';
import {showDialog} from './dialogs.js?v=61';
import {imageTypeNote} from './image-import.js?v=61';
import {identityTransform,transformPoint,composeTransform,imageOperation} from './map-orientation.js?v=61';
import {el,button,label} from './editor-dom.js?v=61';
