import {configureSession,readSessionValue} from './session-storage.js?v=57';
import {customCatalog} from './custom-maps.js?v=57';
import { setupFullscreen } from './fullscreen.js?v=57';
import {storyCatalog} from './story-assets.js?v=57';
import {createStoryPlayer,MODE_FADE_MS} from './story-player.js?v=57';
import {fetchJSON} from './resource-loading.js?v=57';
import { validPresentation, sceneCanShow } from './presentation-state.js?v=57';
