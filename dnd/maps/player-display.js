import {configureSession,readSessionValue} from './session-storage.js?v=44';
import {customCatalog} from './custom-maps.js?v=44';
import { setupFullscreen } from './fullscreen.js?v=44';
import {storyCatalog} from './story-assets.js?v=44';
import {createStoryPlayer,MODE_FADE_MS} from './story-player.js?v=44';
import {fetchJSON} from './resource-loading.js?v=44';
import { validPresentation, sceneCanShow } from './presentation-state.js?v=44';
...
export async function startPlayerDisplay(){
  ...
  function prepare(){
    ...
    const url=new URL(location.href);url.search=new URLSearchParams({view:'player',scene:'1',session,map:presentation.mapId,build:'44'}).toString();frame.src=url;
