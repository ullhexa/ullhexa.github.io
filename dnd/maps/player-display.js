import {customCatalog} from './custom-maps.js?v=20';
import { setupFullscreen } from './fullscreen.js?v=20';
import { STORY_SCENES, createStoryAnimation } from './story-scenes.js?v=20';
import { validPresentation, sceneCanShow } from './presentation-state.js?v=20';
...
export async function startPlayerDisplay(){
  ...
  const response=await fetch('./maps/catalog.json?v=20');if(!response.ok)throw new Error('The map library could not load. Reload to try again.');
