import {configureSession,readSessionValue} from './session-storage.js?v=41';
import {customCatalog} from './custom-maps.js?v=41';
import { setupFullscreen } from './fullscreen.js?v=41';
import {storyCatalog} from './story-assets.js?v=41';
import {createStoryPlayer,MODE_FADE_MS} from './story-player.js?v=41';
import {fetchJSON} from './resource-loading.js?v=41';
import { validPresentation, sceneCanShow } from './presentation-state.js?v=41';
...
export async function startPlayerDisplay(){
  ...
  function prepare(){
    ...
    const url=new URL(location.href);url.search=new URLSearchParams({view:'player',scene:'1',session,map:presentation.mapId,build:'41'}).toString();frame.src=url;
